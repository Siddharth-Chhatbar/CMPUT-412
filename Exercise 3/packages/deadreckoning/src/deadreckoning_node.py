...
class DeadReckoningNode(DTROS):
    ...
    Subscribers:
        ...
        Leftwheel axis and right wheel axis
    """
    ...
    def __init__(self, node_name):
        ...
        # Insted of usinf topic/service we changed the location manually
        self.timestamp = None
        self.x = 0.43
        self.y = 0.235
        self.z = 0.0
    ...
    def publish_odometry(self):
        ...
        odom.header.frame_id = self.origin_frame # changed from self.origin_frame ------------
        odom.pose.pose = Pose(Point(self.x, self.y, self.z), Quaternion(*self.q))
        odom.child_frame_id = self.target_frame # changed from self.target_frame ------------
