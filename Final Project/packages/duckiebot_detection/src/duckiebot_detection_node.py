...
class DuckiebotDetectionNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.srv_node_shutdown = rospy.Service(
            f"/{self.host}/{node_name}/shutdown",
            Shutdown,
            self.cb_shutdown
        )
    ...
    def shutdown_hook(self):
        ...
        rospy.loginfo("SHUTTING DOWN DUCKIEBOT DETECTION NODE")

if __name__ == "__main__":
    duckiebot_detection_node = DuckiebotDetectionNode("duckiebot_detection_node")
    rospy.spin()
