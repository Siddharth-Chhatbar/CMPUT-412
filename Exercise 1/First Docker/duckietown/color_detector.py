...
def gst_pipeline_string():
    ...
    gst_pipeline = 'nvarguscamerasrc sensor-mode=' + str(camera_mode) + ' exposuretimerange="100000 80000000" ! video/x-raw(memory:NVMM, width='+ str(res_w) + ', height='+ str(res_h) +', format=NV12, framerate=' + str(fps) +' ! nvjpegence ! appsink'
